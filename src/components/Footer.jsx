...
function Footer() {
  return (
    <div className="bg-dark-gray md:h-[365px] max-md:h-[400px] max-sm:h-full xl:px-[165px] max-xl:px-[39px] max-sm:px-[24px] pt-[75px] max-sm:pt-[52px] relative  ">
      ...
      <div className="flex justify-between items-center text-white  max-md:flex-col max-md:items-start max-sm:items-center max-md:gap-[32px]">
        <Logo />
        <Navigation />
      </div>
      ...
      <div className="flex justify-between items-start md:mt-[56px] max-md:mt-[80px] max-sm:mt-0 max-sm:flex-col max-sm:items-center max-sm:gap-[48px] max-sm:pb-[38px]">
