...
function Footer() {
  return (
    <footer className="bg-dark-gray md:h-[365px] max-md:h-[400px] max-sm:h-full  xl:px-[165px] max-xl:px-[39px] max-sm:px-[24px] pt-[75px] max-sm:pt-[52px] relative  ">
      ...
      <div className="flex justify-between items-start md:mt-[56px] max-md:mt-[80px] max-sm:mt-[48px] max-sm:flex-col max-sm:items-center max-sm:gap-[48px] max-sm:pb-[38px]">
